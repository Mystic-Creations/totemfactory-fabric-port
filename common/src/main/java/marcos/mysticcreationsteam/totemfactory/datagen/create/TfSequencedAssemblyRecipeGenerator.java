...
public class TfSequencedAssemblyRecipeGenerator extends SequencedAssemblyRecipeGen {
    public TfSequencedAssemblyRecipeGenerator(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
            ...
            .addStep(FillingRecipe::new, rb ->
                ModLoaderHelper.createFluidIngredient(
                    ...
                    DataComponentPatch.builder()
                        .set(DataComponents.POTION_CONTENTS, new PotionContents(Potions.FIRE_RESISTANCE))
                        .set(AllDataComponents.POTION_FLUID_BOTTLE_TYPE, PotionFluid.BottleType.REGULAR)
                        .build()
                )
            )
            .addStep(FillingRecipe::new, rb ->
